...
The one field that cannot be known at render time is the TikTok post ID. Fill in the `publish` block after posting:

```json
"publish": {"post_id": "...", "url": "...", "posted_at": "2026-09-05"}
```
